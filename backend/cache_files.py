...
CRM_PRESCRICOES_ESTABELECIMENTO_MEDICO_MES_CACHE_VERSION = 4
CRM_PRESCRICOES_MEDICO_MUNICIPIO_MES_CACHE_VERSION = 2
CRM_PRESCRICOES_MEDICO_BRASIL_MES_CACHE_VERSION = 1
CRM_PRESCRICOES_GEOGRAFIA_MES_CACHE_VERSION = 3
...
CRM_PRESCRICOES_ESTABELECIMENTO_MEDICO_MES_PARQUET = _module("crm_prescricoes_estabelecimento_medico_mes")
CRM_PRESCRICOES_MEDICO_MUNICIPIO_MES_PARQUET = _module("crm_prescricoes_medico_municipio_mes")
CRM_PRESCRICOES_MEDICO_BRASIL_MES_PARQUET = _module("crm_prescricoes_medico_brasil_mes")
CRM_PRESCRICOES_GEOGRAFIA_MES_PARQUET = _module("crm_prescricoes_geografia_mes")
CRM_MAPA_BRASIL_PERIODO_PARQUET = _module("crm_mapa_brasil_periodo")
