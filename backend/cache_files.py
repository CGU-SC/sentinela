...
CRM_MEDICO_ESTABELECIMENTO_MES_CACHE_VERSION = 4
CRM_PRESCRICOES_MEDICO_MUNICIPIO_MES_CACHE_VERSION = 2
CRM_MEDICO_BRASIL_MES_CACHE_VERSION = 2
CRM_CONTAGEM_MEDICOS_MUNICIPIO_REGIAO_PERIODO_CACHE_VERSION = 4
...
CRM_MEDICO_ESTABELECIMENTO_MES_PARQUET = _module("crm_medico_estabelecimento_mes")
CRM_PRESCRICOES_MEDICO_MUNICIPIO_MES_PARQUET = _module("crm_prescricoes_medico_municipio_mes")
CRM_MEDICO_BRASIL_MES_PARQUET = _module("crm_medico_brasil_mes")
CRM_CONTAGEM_MEDICOS_MUNICIPIO_REGIAO_PERIODO_PARQUET = _module("crm_contagem_medicos_municipio_regiao_periodo")
CRM_CONTAGEM_MEDICOS_UF_BRASIL_PERIODO_PARQUET = _module("crm_contagem_medicos_uf_brasil_periodo")
