...
ARQUIVOS = [
    ...
    {"id": 15, "name": "CRM Médico/Estabelecimento/Mês", "path": _CRM_MEDICO_ESTABELECIMENTO_MES_PATH},
    {"id": 16, "name": "CRM Prescricoes Geografia/Mes", "path": _CRM_PRESCRICOES_GEOGRAFIA_MES_PATH},
    {"id": 17, "name": "CRM Contagem Médicos/UF-Brasil/Período", "path": _CRM_CONTAGEM_MEDICOS_UF_BRASIL_PERIODO_PATH},
    {"id": 18, "name": "CRM Médico/Brasil/Mês", "path": _CRM_MEDICO_BRASIL_MES_PATH},
