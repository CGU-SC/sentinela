...
ARQUIVOS = [
    ...
    {"id": 15, "name": "CRM Prescricoes Estab./Mes", "path": _CRM_PRESCRICOES_ESTABELECIMENTO_MES_PATH},
    {"id": 16, "name": "CRM Prescricoes Gerencial/Mes", "path": _CRM_PRESCRICOES_GERENCIAL_MES_PATH},
