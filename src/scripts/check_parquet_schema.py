...
ARQUIVOS = [
    ...
    {"id": 15, "name": "CRM Prescricoes Estabelecimento/Medico/Mes", "path": _CRM_PRESCRICOES_ESTABELECIMENTO_MEDICO_MES_PATH},
    {"id": 16, "name": "CRM Prescricoes Geografia/Mes", "path": _CRM_PRESCRICOES_GEOGRAFIA_MES_PATH},
    {"id": 17, "name": "CRM Mapa Brasil/Periodo", "path": _CRM_MAPA_BRASIL_PERIODO_PATH},
